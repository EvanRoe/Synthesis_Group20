...
The slack will be negatively affected by clock gating, because we are adding more hardware in the clock path (clock gates), and in this case the slack decreased by 0.295 ns (75 per cent). The reduction in area could be attributed to removing feedback multiplexer loops for load-enable registers. If this design has a lot of registers, this could result in a significant area saving.  
